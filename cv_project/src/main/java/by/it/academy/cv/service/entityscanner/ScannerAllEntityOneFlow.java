...
@Getter
public class ScannerAllEntityOneFlow {

    private final EntityScanner es;
...
//    private ArrayList<Field> manyToManyFields = new ArrayList<>();
    ...
    ScannerAllEntityOneFlow(Class rootClass) {
        this.rootClass = rootClass;
        es = new EntityScanner(rootClass);
        columnNameFieldNameMap = new HashMap<>();
        scanFlow();
    }

    public void scanFlow() {
        rootTableName = es.scanTableName(rootClass);
        es.scanColumnAndFieldsNames(rootClass, columnNameFieldNameMap);
